...
//
//   static const String id = 'registration_screen' ;    // use to redirectnpage, use in main.dart
//
//   @override
...
//                               "email":email, "uid":_auth.currentUser!.uid,
//                            });
//
//                         if(newUser != null){
...
class RegistrationScreen extends StatefulWidget {
  static const String id = 'registration_screen'; // Use to redirect to page, use in main.dart
